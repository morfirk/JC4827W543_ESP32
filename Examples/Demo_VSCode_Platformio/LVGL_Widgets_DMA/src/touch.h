...
#if defined(TOUCH_GT911_MODULE)
// Capacitive touchscreen
#define TOUCH_MODULES_GT911                // GT911 / CST_SELF / CST_MUTUAL / ZTW622 / L58 / FT3267 / FT5x06
#define TOUCH_MODULE_ADDR TOUCH_GT911_ADDR // CTS328_SLAVE_ADDRESS / L58_SLAVE_ADDRESS / CTS826_SLAVE_ADDRESS / CTS820_SLAVE_ADDRESS / CTS816S_SLAVE_ADDRESS / FT3267_SLAVE_ADDRESS / FT5x06_ADDR / GT911_SLAVE_ADDRESS1 / GT911_SLAVE_ADDRESS2 / ZTW622_SLAVE1_ADDRESS / ZTW622_SLAVE2_ADDRESS

#elif defined(TOUCH_XPT2046_MODULE)
...
#include <Wire.h>
#include <TouchLib.h>
TouchLib touch(Wire, TOUCH_GT911_SDA, TOUCH_GT911_SCK, TOUCH_MODULE_ADDR);
...
#elif defined(TOUCH_MODULE_ADDR) // TouchLib
    // Reset touchscreen
#if (TOUCH_GT911_RES > 0)
    pinMode(TOUCH_GT911_RES, OUTPUT);
    digitalWrite(TOUCH_GT911_RES, 0);
    delay(200);
    digitalWrite(TOUCH_GT911_RES, 1);
    delay(200);
#endif
    Wire.begin(TOUCH_GT911_SDA, TOUCH_GT911_SCK);
    touch.init();
...
#elif defined(TOUCH_GT911_MODULE) // TouchLib
    if (touch.read())
    {
